...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        const updateCanvasSize = () => {
            ...
            // Расширяем canvas на 50% больше ширины экрана для избежания обрезки
            canvas.width = (window.innerWidth * 1.5) * dpr;
        ...
        function resetBeam(beam: Beam, index: number, totalBeams: number) {
            ...
            const column = index % 5; // Увеличиваем количество колонок для лучшего покрытия
            ...
            beam.x =
                column * spacing +
                spacing / 2 +
                (Math.random() - 0.5) * spacing * 0.8; // Больше разброса
