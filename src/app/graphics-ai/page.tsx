      ...
      <div className="w-full max-w-md mx-auto flex flex-col relative z-10 min-h-screen">
        ...
        >
          ...
          <div className="text-center mb-10">
            <div className="flex items-center justify-center w-20 h-20 rounded-2xl bg-purple-500/20 backdrop-blur-sm mx-auto mb-6">
          ...
          <div className="space-y-6">
            ...
            >
              ...
              <p className="text-neutral-200 text-sm mb-4">
                Изучите современные инструменты для создания уникальных изображений с помощью искусственного интеллекта.
              </p>
            ...
            >
              <h3 className="text-lg font-semibold text-white mb-3">
                Создание логотипов с AI
              </h3>
              <p className="text-neutral-200 text-sm mb-4">
                Научитесь создавать профессиональные логотипы с помощью искусственного интеллекта.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-purple-400 text-sm font-medium">
                  Средний уровень
            ...
            >
              ...
              <p className="text-neutral-200 text-sm mb-4">
                Создание трехмерных моделей и анимации с использованием передовых ИИ-технологий.
              </p>
              <div className="flex items-center justify-between">
                <span className="text-purple-400 text-sm font-medium">
                  Продвинутый уровень
